...
class Accueil {
  constructor() {
    ...
    this.photographesApi = new PhotographeApi(
      "ressources/data/photographers.json"
    );
  }
  ...
  async main() {
    ...
    let Photographe = photographesData.map(
      (photographe) => new PhotographesFactory(photographe)
    );
